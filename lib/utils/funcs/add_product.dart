...
Future<void> addProduct() async {
  ...
  try {
    await firestore.collection('product').add({
      ...
      'price': 1199.9,
      'imageUrl':
          'https://images.unsplash.com/photo-1612821745127-53855be9cbd1?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1287',
