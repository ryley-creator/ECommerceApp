...
Future<void> addProduct() async {
  ...
  try {
    await firestore.collection('product').add({
      'isFavorite': false,
      'name': 'Iphone 14 pro',
      'description': 'The best phone made by Apple',
      'price': 999.9,
      'imageUrl':
          'https://images.unsplash.com/photo-1663408261842-016bae520a0c?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1287',
