...
Future<void> addProduct() async {
  ...
  try {
    await firestore.collection('product').add({
      ...
      'isFavorite': false,
      'name': 'Macbook Pro',
      'description': 'The best notebook made by Apple',
      'price': 1199.9,
      'imageUrl':
          'https://images.unsplash.com/photo-1569770218135-bea267ed7e84?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1760',
